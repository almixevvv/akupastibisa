        ...
        <div class="col-lg-12" id="tabel">
          <div class="panel panel-default">
            <div class="panel-heading" data-original-title>
              <h2><span class="break"></span>About Us</h2>
              ...
              <table id="subscription_table" name="subscription_table" class="table table-striped table-bordered bootstrap-datatable">
                ...
                <td>
                 ...
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                  data-about="<?php echo $about; ?>">EDIT</button>
               </td>
...
<!-- end content -->
        ...
        <div id="exampleModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <?php echo form_open('Form_about_cms/update'); ?>
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <textarea name="text-about" id="form10" class="md-textarea form-control modal-about" rows="10"></textarea>
  ...
  <script type="text/javascript">
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
      ...
      modal.find('.modal-about').val(about);
    });  
