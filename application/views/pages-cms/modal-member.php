...
<div class="modal-body" style="font-size: 14px;">
  <div class="row" style=" margin-bottom: 1em;">
    <div class="col-lg-4">
    	...
    	<label style="width: 5em;font-weight: bold;">First Name</label>
    	<label style="margin-left: 4em; font-weight: bold;">:</label>
    </div>
    <div class="col-lg-8">
        <input name="member_fname" style="width: 100%" value="<?php echo $data->FIRST_NAME;?>">
    </div>
  </div>

  <div class="row" style=" margin-bottom: 1em;">
    <div class="col-lg-4">
      <label style="width: 5em;font-weight: bold;">Last Name</label>
      <label style="margin-left: 4em; font-weight: bold;">:</label>
    </div>
    <div class="col-lg-8">
        <input name="member_lname" style="width: 100%" value="<?php echo $data->LAST_NAME;?>">
    </div>
  </div>
