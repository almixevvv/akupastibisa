        ...
        <div class="col-lg-12" id="tabel">
          <div class="panel panel-default">
            <div class="panel-heading" data-original-title>
              <h2><span class="break"></span>Privacy Police</h2>
              ...
              <table id="subscription_table" name="subscription_table" class="table table-striped table-bordered bootstrap-datatable">
                ...
                <td>
                 ...
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                  data-privacy='<?php echo $privacy; ?>'>EDIT</button>
               </td>
...
<!-- end content -->
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <textarea name="text-privacy" id="form10" class="md-textarea form-control modal-privacy" rows="10"></textarea>
  ...
  <script type="text/javascript">
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
      ...
      var privacy = button.data('privacy');
      
      // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
      // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
      var modal = $(this);

      modal.find('.modal-privacy').val(privacy);
    });  
