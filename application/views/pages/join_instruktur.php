<style>
    .instructor_banner_area {
    	z-index: 1;
    	position: relative;
    	background: url(../../assets/img/banner/instructor-banner.jpg) no-repeat center;
    	background-size: cover;
    	height: 350px;
    	background-position: 50% 20%;
    }
    .instructor_banner_area .banner_inner {
    	position: absolute;
    	top: 60%;
    ...
    .instructor_banner_area .banner_inner .banner_content h2 {
    	font-size: 48px;
    	font-weight: 500;
    }
    .instructor_banner_area .banner_inner .banner_content p {
    	font-size: 20px;
    	color: #002347;
    	font-weight: 500;
    }
...
<section class="instructor_banner_area">
