                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                ...
                                <div class="blog_details">
                                    ...
                                    <a href="<?php echo base_url('blogdetail'); ?>" class="blog_btn">View More</a>
                                </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <aside class="single-sidebar-widget newsletter_widget">
                        ...
                        <div class="form-group d-flex flex-row">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Enter email" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Enter email'" data-cf-modified-c834c9c7f49dc9fe7e5b79e5-="">
                            </div>
