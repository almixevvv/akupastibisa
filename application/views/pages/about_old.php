        ...
        <div class="row h_blog_item">
            <div class="col-lg-6">
                <div class="h_blog_img">
                    <img class="img-fluid" src="<?php echo base_url('assets/img/about.png'); ?>" alt="About Image" />
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="testi_slider owl-carousel">
                <div class="testi_item">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <img <?php echo base_url('assets/img/testimonials/t1.jpg'); ?>" alt="" />
                        </div>
                        <div class="col-lg-8">
                ...
                <div class="testi_item">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <img <?php echo base_url('assets/img/testimonials/t2.jpg'); ?> alt="" />
                        </div>
                        <div class="col-lg-8">
                            <div class="testi_text">
                                <h4>Davil Saden</h4>
