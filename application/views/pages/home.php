            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        ...
                        <div>
                            <a href="#" class="primary-btn2 mb-3 mb-sm-0" style="color: #ffff;">Lihat Lainnya</a>
...
<section class="populer_courses">
    <div class="container mt-5 pt-3">
        ...
        <div class="row pt-2">
            <div class="col-12">
                <p style="color: #838080;">Mari <a href="#">bergabung</a> bersama kami dan pilih dari ribuan kelas online dan </br>terus bertambah setiap bulannya</p>
            </div>
        </div>
                    ...
                    <a class="course-link" href="#">
                        ...
                        <div class="popular-price pb-2">
                            <div class="d-flex">
                                ...
                                <span class="price-regular">Rp. 2.000.000 </span>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center d-flex align-items-center">
            ...
            <!-- <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
                ...
                <div class="meta-text text-sm-center">
                    <h4>David Cameron</h4>
                    <p class="designation p-color">Sr. web designer</p>
                    <div class="mb-4">
                        <p class="p-color">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
                ...
                <div class="meta-text text-sm-center">
                    <h4>Jain Redmel</h4>
                    <p class="designation p-color">Sr. Faculty Data Science</p>
                    <div class="mb-4">
                        <p class="p-color p-color">
                            If you are looking at blank cassettes on the web, you may be
                            very confused at the.
                        </p>
                    </div>
        ...
        <div class="row justify-content-center d-flex align-items-center">
            <h4 class="p-color">Ayo, jadi <a href="<?php echo base_url('home/instruktur'); ?>">instruktur</a> sekarang! </h4>
        </div>
    </div>
</section>
