                ...
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="<?php echo base_url('blogdetail'); ?>">Blog Details</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form>
                        <div class="form-group form-inline">
                            <div class="form-group col-lg-6 col-md-6 name">
                                <input type="text" class="form-control" id="name" placeholder="Enter Name" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Enter Name'" data-cf-modified-9d85699cab7925e1f90cf3eb-="">
                            </div>
                            <div class="form-group col-lg-6 col-md-6 email">
                                <input type="email" class="form-control" id="email" placeholder="Enter email address" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Enter email address'" data-cf-modified-9d85699cab7925e1f90cf3eb-="">
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="subject" placeholder="Subject" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Subject'" data-cf-modified-9d85699cab7925e1f90cf3eb-="">
                        </div>
                        <div class="form-group">
                            <textarea class="form-control mb-10" rows="5" name="message" placeholder="Messege" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Messege'" required="" data-cf-modified-9d85699cab7925e1f90cf3eb-=""></textarea>
                        </div>
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            ...
                            <div class="media-body">
                                <a href="<?php echo base_url('blogdetail'); ?>">
                    ...
                    <aside class="single-sidebar-widget newsletter_widget">
                        ...
                        <div class="form-group d-flex flex-row">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Enter email" onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''" onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Enter email'" data-cf-modified-9d85699cab7925e1f90cf3eb-="">
                            </div>
