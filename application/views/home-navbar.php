                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex justify-content-between">Pengembangan <i class="pt-1 ml-3 ti-angle-right"></i></div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex justify-content-between">Bisnis<i class="pt-1 ml-3 ti-angle-right"></i></div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex justify-content-between">Keuangan dan Akuntansi<i class="pt-1 ml-3 ti-angle-right"></i></div>
                                    </a>
                                </div>
                            </div>
                        </li>
